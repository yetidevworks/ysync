...
For the latest main branch, replace `--tag v0.2.3` with `--branch main`. To update an installed service: stop it, install the desired tag with `--force`, and start it again. Reinstall the service definition if the binary's installation path changes.
...
```sh
curl -fLO https://github.com/yetidevworks/ysync/releases/download/v0.2.3/ysync-v0.2.0-aarch64-apple-darwin.tar.gz
curl -fLO https://github.com/yetidevworks/ysync/releases/download/v0.2.3/SHA256SUMS
